<template>
  <div class="index" style="margin-bottom:60px">
    <Myfooter />
    <nav class="nav_one">
      <div><img src="@/assets/images/企业主贷.png" alt=""></div>
      <p>首页</p>
      <div @click="tonews"><img src="@/assets/images/消息.png" alt=""></div>
    </nav>
    ...
    <div class="nav_two">
      ...
      <dl @click="topaihang"><dt><img src="@/assets/images/速贷排行.png" alt=""></dt>
        <dd>速贷排行</dd>
      </dl>
      <dl><dt><img src="@/assets/images/还款提醒.png" alt=""></dt>
        <dd>还款提醒</dd>
      </dl>
    </div>
    ...
    <div class="nav_three">
      <dl><dt><img src="@/assets/images/学生贷.png" alt=""></dt>
        <dd>学生贷</dd>
      </dl>
      <dl><dt><img src="@/assets/images/工薪贷.png" alt=""></dt>
        <dd>工薪贷</dd>
      </dl>
      <dl><dt><img src="@/assets/images/企业主贷.png" alt=""></dt>
        <dd>企业主贷</dd>
      </dl>
    </div>
    <div class="advisory">
      <p class="p_one pclick_three">咨询 <span class="span_three">更多></span></p>
      <dl class="dl"><dt><img src="@/assets/images/5.jpg" alt=""></dt>
        <dd>
          <h4>这是一个无耻的标题党</h4>
          <p>这是一段无耻标题党下的无耻的内容</p>
        </dd>
      </dl>
      <div class="foot">
        <dl><dt><img src="@/assets/images/已看.png" alt=""></dt>
          <dd>1234 </dd>
        </dl>
        <dl><dt><img src="@/assets/images/收藏1.png" alt=""></dt>
          <dd>1234 </dd>
        </dl><span>30分钟前 </span>
      </div>
      <dl class="dl"><dt><img src="@/assets/images/6.jpg" alt=""></dt>
        <dd>
          <h4>这是一个无耻的标题党</h4>
          <p>这是一段无耻标题党下的无耻的内容</p>
        </dd>
...
<style scoped lang="less">
  ...
  .nav_one {
    height: 1.3333rem;
    display: flex;
    background-color: rgb(47, 72, 100);
    align-items: center;
    text-align: center;
